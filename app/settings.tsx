  ...
  const handleAction = (action: string) => {
    switch (action) {
      ...
      case "downloadData":
        Alert.alert(
          "Yuklash Boshlandi",
          "Ma'lumotlaringiz 24-48 soat ichida tayyor bo'ladi"
        );
        break;
      default:
  ...
  const sections: SettingSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          subtitle: "Push bildirishnomalar",
    ...
    },
    {
      ...
      items: [
        {
          id: "autoplay",
          title: "Videoları Avtomatik Ijro Etish",
          subtitle: "Mobil internetda",
        ...
        {
          id: "dataUsage",
          title: "Maʼlumot Tejash",
          subtitle: "Maʼlumot sarfini kamaytiring",
        ...
        {
          id: "downloads",
          title: "Yuklab Olingan Videolar",
          subtitle: "Oflayn kontent boshqaruvi",
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: "readReceipts",
          title: "O'qilgan Qabul Qiluvchilar",
          subtitle: "O'qilgan holatini ko'rsatish",
        ...
        },
        {
          ...
          subtitle: "Bloklangan akkauntlarni boshqaring",
          icon: "ban-outline",
          type: "navigate",
          color: "#ff3b5c",
        },
        {
          id: "mutedAccounts",
          title: "Ovozsiz Qilingan Akkauntlar",
          subtitle: "Ovozsiz qilingan akkauntlar",
    ...
    },
    {
      ...
      items: [
        {
          id: "twoFactor",
          title: "Ikki faktli Autentifikatsiya",
          subtitle: "Qo'shimcha xavfsizlik qatlami",
        ...
        },
        {
          ...
          subtitle: "Parolingizni yangilang",
          icon: "key-outline",
          type: "navigate",
          color: "#5e5ce6",
        },
        {
          ...
          subtitle: "Tizimga kirgan qurilmalarni boshqaring",
          icon: "phone-portrait-outline",
          type: "navigate",
          color: "#5e5ce6",
        },
        {
          id: "loginActivity",
          title: "Kirish Faoliyati",
          subtitle: "So'nggi kirishlarni ko'ring",
          icon: "time-outline",
          type: "navigate",
          color: "#5e5ce6",
        },
      ...
      items: [
        {
          ...
          subtitle: "Tez-tez soʻragan savollar va yordam",
        ...
        },
        {
          ...
          subtitle: "Biror narsa ishlamayapti?",
          icon: "flag-outline",
          type: "navigate",
          color: "#ff9500",
        },
        {
          ...
          subtitle: "Sizning fikringizni eshitmishni istaydi",
        ...
        {
          id: "about",
          title: "PlayVibe Haqida",
          subtitle: "1.0.0 Versiyasi",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          subtitle: "Ma'lumotlaringizning nusxasini oling",
        ...
        {
          id: "storage",
          title: "Saqlash Joyidan Foydalanish",
          subtitle: "2.4 GB",
          icon: "folder-outline",
          type: "navigate",
          color: "#5e5ce6",
